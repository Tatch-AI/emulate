...
Local drop-in replacement for Vercel, GitHub, Google, Slack, Apple, Microsoft, Okta, AWS, Resend, Stripe, MongoDB Atlas, Clerk, Linear, Twilio, OpenAI, Anthropic, PostHog, OpenPhone, Knock, and Deepgram APIs. Built for CI and no-network sandboxes. Fully stateful, production-fidelity API emulation. Not mocks.
