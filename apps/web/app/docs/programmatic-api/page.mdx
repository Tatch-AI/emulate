...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>Service name: <code>'vercel'</code>, <code>'github'</code>, <code>'google'</code>, <code>'slack'</code>, <code>'apple'</code>, <code>'microsoft'</code>, <code>'okta'</code>, <code>'aws'</code>, <code>'resend'</code>, <code>'stripe'</code>, <code>'mongoatlas'</code>, <code>'clerk'</code>, <code>'linear'</code>, <code>'twilio'</code>, <code>'openai'</code>, <code>'anthropic'</code>, <code>'posthog'</code>, <code>'openphone'</code>, <code>'knock'</code>, or <code>'deepgram'</code></td>
    </tr>
    <tr>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>@emulators/openai</code></td><td>OpenAI chat, responses, embeddings, audio, batches</td></tr>
    <tr><td><code>@emulators/anthropic</code></td><td>Anthropic Messages API, streaming, batches</td></tr>
    <tr><td><code>@emulators/posthog</code></td><td>PostHog capture, decide/flags, private API</td></tr>
    <tr><td><code>@emulators/openphone</code></td><td>OpenPhone messages, calls, contacts, webhooks</td></tr>
    <tr><td><code>@emulators/knock</code></td><td>Knock workflows, feeds, messages, preferences</td></tr>
    <tr><td><code>@emulators/deepgram</code></td><td>Deepgram listen, speak, read, management API</td></tr>
