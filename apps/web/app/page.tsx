    ...
    <div className="relative">
      ...
      <section className="mx-auto max-w-3xl px-6 pb-20 pt-16 sm:pt-24">
        ...
        <p className="mb-8 max-w-xl text-base text-neutral-600 dark:text-neutral-400">
          Stateful, production-fidelity replacements for Stripe, GitHub, Google, AWS, OpenAI, and 15 more services. No
          API keys. No network. Not mocks.
        </p>
          ...
          <div className="grid gap-x-12 gap-y-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-sm text-neutral-600 dark:text-neutral-400">
                ...
                and all 20 services start with sensible defaults. Seed data via YAML when you need it.
              </p>
            </div>
            <div>
