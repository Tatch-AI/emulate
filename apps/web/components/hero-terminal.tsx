...
const services = [
  ...
  { name: "OpenAI", port: 4014, slug: "openai" },
  { name: "Anthropic", port: 4015, slug: "anthropic" },
  { name: "PostHog", port: 4016, slug: "posthog" },
  { name: "OpenPhone", port: 4017, slug: "openphone" },
  { name: "Knock", port: 4018, slug: "knock" },
  { name: "Deepgram", port: 4019, slug: "deepgram" },
];
